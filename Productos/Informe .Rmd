...
debe tener al rededor de 300 palabras con spoilers :v
- 1 o 2 oraciones para el tema
- 1 oracion para el objetivo
- 1 oracion para los datos
- 1 oracion para los principales resultados
- 1 oracion para las principales conclusiones y proyecciones
...
-se presentan los datos: cómo se obtuvieron, qué características tenían originalmente, modificaciones y características base de datos final.
-se presentan los metodos a utilizar (solo si se usan no descriptivos)
