...
En consecuencia, se puede insinuar que existe una especialización de J.K. Rowling en dicha categoría, provocando que ella posea un promedio alto en rating_avg. Por este motivo, se decidió mostrar los autores que poseían al menos una calificación en algunos de sus libros, pertenecientes a las 10 categorías principales del Top-Seller.
...
Como se puede observar, J.K. Rowling obtuvo un rating_avg = 5 en uno de sus libros pertenecientes a la categoría *Contemporary Fiction* que **NO** es la misma clasificación que se asumió la existencia de una especialización por parte de la autora. También se observa que, el autor Axel Scheffler obtuvo una puntuación perfecta, pese a que él posee una variedad de clasificaciones, con respecto a la categoría, de sus libros; tales como *Adventure Books for Kids*, *Children's Fiction*, *Fantasy Books for Kids*, entre otros. 
